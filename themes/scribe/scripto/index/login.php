...
-->
            <li><a href="http://libdev.haverford.edu/transcriber/index.php?title=Special:UserLogin&returnto=Main+Page&type=signup" target="_blank"><?php echo __('Create an account'); ?></a></li>
        ...
        <p><?php echo __(
          ...
          . 'and enable certain Scripto features. Login is required by the administrator to make any changes or particpate in discussions.'
        ); ?></p>
